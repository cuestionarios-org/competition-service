...
class CompetitionQuizParticipants(db.Model):
    ...
    # score competition: Puntaje basado en como quedo posicionado en la resolucion del quiz, si quedo primero, cuerto, etc, es el puntaje que sumara a la competencia.
